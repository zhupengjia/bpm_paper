...
the assumption of the infinitely long chamber and the negligible antenna
influence for the electric field inside the chamber, the signal from
each antenna excited by the beam can be calculated via image charge
method (Fig. \ref{fig:mirror_method}) \citep{carmanbpm,piotbpm}
: 
